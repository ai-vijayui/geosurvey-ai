...
export function EmptyState({ eyebrow, title, description, action, compact = false, icon = "spark" }: EmptyStateProps) {
  return (
    <div className={`flex flex-col items-center justify-center rounded-[28px] border border-dashed border-[#eadfd5] bg-[#faf7f3] px-6 text-center ${compact ? "min-h-[12rem] py-6" : "min-h-[18rem] py-10"}`}>
      <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-[#ff746c] to-[#f0453f] text-white shadow-[0_14px_30px_rgba(240,69,63,0.22)]" aria-hidden="true">
